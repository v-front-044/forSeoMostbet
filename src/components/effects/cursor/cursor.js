...
export function customCursor() {
	const wrapper = document.querySelector('[data-fls-cursor]') ? document.querySelector('[data-fls-cursor]') : document.documentElement;
	if (wrapper && !isMobile.any()) {
		const isShadowTrue = document.querySelector('[data-fls-cursor]').dataset.flsCursor === 'shadow'
